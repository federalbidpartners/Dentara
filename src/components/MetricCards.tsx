import { CheckCircle2, CircleDollarSign, XCircle, AlertCircle, CalendarDays, SendHorizonal } from "lucide-react";
import type { ReactNode } from "react";
import { Patient } from "../lib/types";
import { getClaimSubmissionSummary, getEstimateIQ, getVisitReadiness } from "../lib/engines";
...
export function MetricCards({ patients }: MetricCardsProps) {
  ...
  return (
    <section className="metric-grid" aria-label="Daily metrics">
      ...
      <MetricCard title="Clean Claims" value={`${claimSummary.cleanClaimRate}%`} detail={`${claimSummary.readyClaims} ready to send`} icon={<SendHorizonal />} tone="blue" />
